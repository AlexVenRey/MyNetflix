...
<body class="banner">
    ...
    <div class="page-border">
        ...
        if (isset($_GET['id_rol'])) {
            ...
            $stmtRol->execute();
            $resultado = $stmtRol->fetch(PDO::FETCH_ASSOC);
        ?>
            <form id="editarRolForm" method="POST" style="text-align: center;">
                <input type="hidden" name="id_rol" value="<?php echo $resultado['id_rol']; ?>">
                <div class="inputs">
                    <label for="rol" class="textos5">Nombre del Rol</label><br>
                    <input type="text" name="rol" id="administraciones" value="<?php echo $resultado['rol']; ?>" required>
                </div>
                <br>
        ...
        function actualizarRol(event) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    window.location.href = "../administrar.php"; // redirigir
                } else {
