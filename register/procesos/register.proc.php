...
if (password_verify($confirmar_contrasena, $hash)) {
    ...
    $sql_insert_user = "INSERT INTO usuarios (nombre, apellidos, email, contrasena, rol, estado) VALUES (:usuario, :apellidos, :email, :password, 1, :registrado)";
    ...
    $stmt_insert_user->bindParam(':registrado',$estado);
